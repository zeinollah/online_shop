...
class SellerProfile(models.Model):
    ...
    id_card_picture = models.ImageField(_('ID card picture'), upload_to='seller/id_card_pics', blank=True, null=True)
...
class Store(models.Model):
    ...
    store_name = models.CharField(_('store name'), max_length=50)
    store_phone_number = models.CharField(_('phone number'), max_length=11, blank=True, null=True)
    ...
    store_post_code = models.CharField(_('Post Code'), max_length=10, blank=True, null=True)
